		...
		<Section classProp={`${career.section} borderBottom`}>
			<Container spacing={['verticalXXXLrg']}>
				...
				<section className={career.area}>
						...
						<h3>Full Stack Developer - Astra International Tbk</h3>
									<h4>2023 · 2024</h4>
							</span>
							<p>
							...
							<p>
							Improved Astra&apos;s Single Sign-On (SSO) solution using Microsoft Azure AD and AD B2C.
							</p>
							<p>
							Enhanced computing solutions for Astra&apos;s website using AWS services, including improvements to EC2 instances and Lambda functions.
							</p>
							<p>
							Optimized relational database solutions utilizing AWS services.
							</p>
							<p>
							Implemented monitoring solutions with Kubernetes and participated in automations using Docker and cronjobs.
							</p>
						</div>
