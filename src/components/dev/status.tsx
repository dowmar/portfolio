                    ...
                    {WelMsg && (
                        <div>
                            <h2 style={{ fontSize: '32px', marginBottom: '20px'}}>
                                <span dangerouslySetInnerHTML={{ __html: WelMsg.replace('Github', '<a href="https://github.com/dowmar" target="_blank" rel="noopener noreferrer" style="color: #3498db;">Github</a>') }} />
                            </h2>
                            {timerRemaining !== null && (
