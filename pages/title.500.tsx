...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Aryasatya Bhagaskara</title>
            ...
            <meta name="keywords" content="500, internal server error, Aryasatya Bhagaskara, Portfolio,broken link ,missing page,link not found" />
