...
export default function Title404() {
    return (
        <Head>
            ...
            <title>404 - Page Not Found | Aryasatya Bhagaskara</title>
            ...
            <meta name="keywords" content="404, Page Not Found, Aryasatya Bhagaskara, Portfolio,broken link ,missing page,link not found" />
