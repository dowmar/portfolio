...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Aryasatya Bhagaskara</title>
            <meta name="description" content="Explore articles authored by Aryasatya Bhagaskara, a Full Stack Engineer and Developer." />
